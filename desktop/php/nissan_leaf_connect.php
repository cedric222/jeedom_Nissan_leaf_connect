...
sendVarToJS('eqType', 'nissan_leaf_connect');
...
foreach ($eqLogics as $eqLogic) {
	...
	echo "<center>";
	echo '<img src="plugins/nissan_leaf_connect/doc/images/nissan_leaf_connect_icon.png" height="105" width="95" />';
	echo "</center>";
...
?>
       ...
       <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="eqLogicAttr configuration form-control" data-l1key="configuration" data-l2key="username" placeholder="username"/>
        </div>
       </div>
       <div class="form-group">
        <label class="col-sm-3 control-label">{{password}}</label>
        <div class="col-sm-3">
            <input type="text" class="eqLogicAttr configuration form-control" data-l1key="configuration" data-l2key="password" placeholder="password"/>
        </div>
       </div>
</fieldset>
</form>
...
<?php include_file('desktop', 'nissan_leaf_connect', 'js', 'nissan_leaf_connect');?>
